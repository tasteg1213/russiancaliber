...
<html lang="<?=LANGUAGE_ID?>">
	<head>
<meta name="mailru-verification" content="a94e6b45c5723002" />
        ...
        <?=$APPLICATION->ShowViewContent('canonical_detail');?>
		<?CJSCore::Init(array("fx", "ajax", "window", "popup", "jquery"));?>
		...
		<?if(DwSettings::isPagen()):?>
			<?//$APPLICATION->AddHeadString('<link rel="canonical" href="'.DwSettings::getPagenCanonical().'" />');//pagen canonical?>
		<?endif;?>
		<?if(!empty($arTemplateSettings["TEMPLATE_METRICA_CODE"])):?>
			<?$APPLICATION->AddHeadString($arTemplateSettings["TEMPLATE_METRICA_CODE"]);//metrica counter code?>
		<?endif;?>
		<?$APPLICATION->ShowHead();?>
		<title>
            <?$APPLICATION->ShowTitle();?>
            <? $APPLICATION->IncludeComponent("BKV:geo_data", "title", Array())?>
        </title>
