...
$arTemplateParameters["TEXT_NAME_MODEL"] = array(
    "NAME" => GetMessage("PARAP_TEXT_NAME_MODEL"),
    "TYPE" => "STRING",
    "PARENT" => "BASE",
    "DEFAULT" => GetMessage("TEXT_NAME_MODEL_STRING"),
    "VALUE" => ""
);
$arTemplateParameters["IBLOCK_ID_MODEL"] = array(
    "NAME" => GetMessage("PARAM_IBLOCK_ID_MODEL"),
    "TYPE" => "STRING",
    "PARENT" => "BASE",
    "DEFAULT" => "14",
    "VALUE" => ""
