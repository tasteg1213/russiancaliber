<?$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/headers/header2/css/style.css");?><?$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/headers/header2/css/types/".$TEMPLATE_HEADER_TYPE.".css");?>
					...
					<div id="topHeading">
                        ...
                        <div id="topCallback" class="telephone">
                            <div class="wrap">
								...
								<!--<div class="socserw_header">
								   <a href="https://wa.me/+79609044006" class=" header_whatsapp"></a>
								   <a href="tg://resolve?domain=russiancaliber" class="header_telegram"></a>
								</div>-->
