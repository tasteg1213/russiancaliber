$(function(){
	...
	var setLocationFromServer = function(event){
		...
		$.getJSON(geoPositionAjaxDir + "/ajax.php", {
			...
			if(jsonData["SUCCESS"] == "Y"){
				...
				$.getJSON(geoPositionAjaxDirRelocation + "/ajax.php", {
					act: "getPosition",
					// locationID: $(".geo-location-window-search-input").data("id")
				}, function(dataLoc){
					// console.log(dataLoc);
					...
					if(dataLoc["SUCCESS"] == "Y"){
						window.location.replace(dataLoc.SCHEME+'://'+dataLoc.RELOCATION+page);
					}
				});
			}
		});
	...
	var redirects301 = function (jsonObject) {


		if(jsonObject.redirect301){
			//window.location.replace( jsonObject.redirect301 );
		}
	}
});