						...
						<li>
							<div class="item product">
								<div class="tabloid">
									...
									<?if(!empty($arElement["PRICE"]["MIN_PRICE"])):?>
										<a class="price"><?=$arElement["PRICE"]["MIN_PRICE"]["PRINT_DISCOUNT_VALUE"]?>
											<?if(!empty($arElement["PRICE"]["MIN_PRICE"]["PRINT_DISCOUNT_DIFF"]) && $arElement["PRICE"]["MIN_PRICE"]["PRINT_DISCOUNT_DIFF"] > 0):?>
												<s class="discount"><?=$arElement["PRICE"]["MIN_PRICE"]["PRINT_VALUE"]?></s>
											<?endif;?>
										</a>
									<?else:?>
