...
$res = CIBlockElement::GetList(Array(),
    Array("IBLOCK_ID"=>$IBLOCK_ID, "!PROPERTY_YMLINVALID"=>false),
    false,
    Array(),
    Array("ID")
);
while($ob = $res->GetNextElement())
    $ar_filter_ID[] = $ob->GetFields()['ID'];
if(!count($ar_filter_ID))
    $dop_filter_ID = array('0');
...
if (empty($arRunErrors))
{
    ...
    do
    {
        ...
        $skuIdsList = array();
        $simpleIdsList = array();
        $filter["!PROPERTY_YMLINVALID"] = false;
