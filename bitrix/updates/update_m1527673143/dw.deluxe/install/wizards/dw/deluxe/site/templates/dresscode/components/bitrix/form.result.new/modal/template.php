								...
								<div class="personalInfo">
									<div class="webFormItem">
										...
										<div class="webFormItemField" data-required="Y">
											<input type="checkbox" class="personalInfoField" name="personalInfo" value="Y"><label class="label-class" for="personalInfoField"><?=getMessage("PERSONAL_INFO_REQUIRED")?><span class="webFormItemRequired">*</span></label>
										</div>
									</div>
								</div>
