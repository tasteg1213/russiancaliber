	...
	<div style="min-width:600px;max-width:600px;margin:auto;">
		...
		<div style="padding-top:18px;padding-right:24px;padding-bottom:24px;padding-left:24px;background-color:#ffffff;">
			...
			<div style="margin-top:24px;margin-bottom:20px;padding-top:24px;padding-left:18px;padding-bottom:42px;padding-right:18px;text-align:center;color:#000000;background:#f3f3f3;">
				...
				<a href="#SERVER_NAME#/personal/order/" style="display:block;padding-top:12px;padding-right:18px;padding-bottom:14px;padding-left:18px;font-weight:normal;font-family:'Arial',sans-serif;font-size:16px;line-height:16px;background: #63c322;color:#fefefe;text-decoration:none;border-radius:2px;">Оплатить заказ</a>
			</div>
